    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      ...
      <header className="relative text-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="https://images.pexels.com/photos/7291879/pexels-photo-7291879.jpeg"
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 sm:py-16 lg:py-20">
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl xl:text-6xl mb-3 sm:mb-4 drop-shadow-lg">
              Discover Our Blog
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-emerald-50 max-w-2xl mx-auto drop-shadow-md">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-3 sm:py-4 text-sm sm:text-base border-2 border-gray-200 rounded-xl focus:border-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-800 focus:ring-opacity-20 transition-all"
                />
                <button
            ...
            <div className="hidden lg:block">
              <select
                ...
                className="w-full sm:w-auto px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base border-2 border-gray-200 rounded-xl focus:border-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-800 focus:ring-opacity-20 cursor-pointer font-medium text-emerald-800 bg-white transition-all appearance-none pr-10"
                style={{ 
            ...
            <button
              ...
              className="lg:hidden flex items-center justify-center gap-2 px-4 py-3 bg-emerald-800 hover:bg-emerald-900 text-white rounded-xl font-medium transition-colors"
            >
              <Filter size={18} />
              <span>Filter</span>
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-16 h-16 border-4 border-emerald-800 border-t-transparent rounded-full animate-spin mb-4"></div>
            ...
            {blogs.map((blog) => (
              ...
              >
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <h2 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900 line-clamp-2 group-hover:text-emerald-800 transition-colors">
                    {blog.title}
                  </h2>
                  ...
                  <a
                    href={`/blog/${blog.id}`}
                    className="inline-flex items-center gap-2 text-emerald-800 hover:text-emerald-900 font-semibold text-sm sm:text-base group/link transition-colors"
                  >
                    <span>Read More</span>
