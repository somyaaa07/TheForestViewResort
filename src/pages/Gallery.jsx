...
const images = [
  ...
  { id: 6,  src: "/6.jpeg",  label: "Garden Room",         desc: "Wake to wildflowers and birdsong through floor-to-ceiling glass.", tall: true  },
  { id: 7,  src: "/7.jpeg",  label: "The Stone Table",     desc: "Fine dining sourced entirely from our surrounding forest and farms.", tall: false },
  ...
  { id: 12, src: "/12.jpeg", label: "Creek Cottage",       desc: "A secluded stone cottage perched above a whispering mountain creek.", tall: false },
   { id: 9,  src: "/13.jpeg",  label: "Birchwood Suite",     desc: "Pale birch panels, hand-stitched linens, and deep forest views.", tall: true  },
  { id: 10, src: "/14.jpeg", label: "Morning Trail",       desc: "Guided dawn walks through old-growth forest — solitary or accompanied.", tall: false },
