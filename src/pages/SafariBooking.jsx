...
const packages = [
  {
    ...
    accentLight: "#fef3c7",
    accentDark: "#d97706",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Great_Indian_Bustard_%28Ardeotis_nigriceps%29_in_Desert_National_Park%2C_Rajasthan_W_IMG_9502.jpg/1280px-Great_Indian_Bustard_%28Ardeotis_nigriceps%29_in_Desert_National_Park%2C_Rajasthan_W_IMG_9502.jpg",
    heroImg: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600&q=80",
  ...
  },
  {
    ...
    accentLight: "#d1fae5",
    accentDark: "#059669",
    heroImg: "https://images.unsplash.com/photo-1549366021-9f761d450615?w=600&q=80",
  ...
  },
  {
    ...
    accentLight: "#fce7f3",
    accentDark: "#db2777",
    heroImg: "https://images.unsplash.com/photo-1545259742-56e0a0d27aca?w=600&q=80",
  ...
  },
  {
    ...
    accentLight: "#ede9fe",
    accentDark: "#7c3aed",
    heroImg: "https://images.unsplash.com/photo-1616118132534-381148898bb4?w=600&q=80",
...
const activities = [
  { icon: Binoculars, title: "Wildlife Spotting", desc: "Spot the Big Five of India — tiger, leopard, sloth bear, elephant & wild boar — in their natural habitat across Rajasthan's diverse reserves." },
  { icon: Camera, title: "Wildlife Photography", desc: "Capture stunning shots of Bengal tigers, leopards perched on granite boulders, flamingos at dawn and hundreds of rare bird species." },
  { icon: Tent, title: "Luxury Camping", desc: "Sleep under a canopy of stars in luxury tented camps inside the jungle or on the sand dunes of the Thar Desert." },
  { icon: Flame, title: "Sundowners & Bonfires", desc: "Sip cocktails at boulder sundowners in Jawai or gather around a campfire in the desert while folk artists perform traditional Rajasthani music." },
  { icon: TreePine, title: "Nature Walks", desc: "Walk softly through the forest on guided nature trails, learning to read animal tracks, bird calls and signs of the wild around you." },
];
...
const places = [
  {
    ...
    tag: "Tiger Reserve",
    img: "https://images.unsplash.com/photo-1561731216-c3a4d99437d5?w=500&q=80",
    tagColor: "#d97706",
    tagBg: "#fef3c7",
  ...
  },
  {
    ...
    tag: "Desert Safari",
    img: "https://images.unsplash.com/photo-1518623489648-a173ef7824f3?w=500&q=80",
    tagColor: "#b45309",
    tagBg: "#fef9c3",
  ...
  },
  {
    ...
    tag: "Tiger & Ruins",
    img: "https://images.unsplash.com/photo-1567306301408-9b74779a11af?w=500&q=80",
    tagColor: "#1d4ed8",
    tagBg: "#dbeafe",
    info: "Ancient temples and tiger territory meet in the Aravalli Hills. Ancient Kankwari Fort sits deep inside the jungle.",
  },
  {
  ...
  },
  {
    ...
    tag: "Wolf & Leopard",
    img: "https://images.unsplash.com/photo-1527236438218-d82077ae1f85?w=500&q=80",
    tagColor: "#0f766e",
    tagBg: "#ccfbf1",
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily:"'Jost',sans-serif", background:"#c9d4cb", minHeight:"100vh", color:"#1a3d2b" }}>
      <style>{`
        ...
        input,textarea,button,select{font-family:'Jost',sans-serif;outline:none}
        ...
        .place-card{overflow:hidden;border-radius:16px;background:#fff;box-shadow:0 2px 16px rgba(26,61,43,.08);transition:transform .22s,box-shadow .22s;cursor:default}
        ...
        .month-btn{border:none;cursor:pointer;transition:all .15s;font-family:'Jost',sans-serif}
        .month-btn:hover:not(.on){background:#c4d4c8!important}

        .btn-primary{border:none;cursor:pointer;transition:background .15s,transform .1s,box-shadow .15s}
        .btn-primary:hover:not(:disabled){background:#14301f!important;box-shadow:0 6px 20px rgba(26,61,43,.3)}
        .btn-primary:active:not(:disabled){transform:scale(.98)}

        .btn-ghost{cursor:pointer;transition:all .15s}
      ...
      {/* ═══ HERO ═══════════════════════════════════════════ */}
      <header style={{ background:"#1a3d2b", position:"relative", overflow:"hidden" }}>
        <div style={{ position:"absolute", top:-80, right:-60, width:360, height:360, borderRadius:"50%", background:"rgba(201,212,203,.07)", pointerEvents:"none" }}/>
        <div style={{ position:"absolute", bottom:-100, left:60, width:240, height:240, borderRadius:"50%", background:"rgba(201,212,203,.04)", pointerEvents:"none" }}/>

        <div style={{ maxWidth:1160, margin:"0 auto", padding:"52px 32px 64px", position:"relative" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:32 }}>
            <div style={{ flex:1, minWidth:260 }}>
              <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:20 }}>
                <div style={{ width:34, height:34, borderRadius:10, background:"rgba(201,212,203,.13)", display:"flex", alignItems:"center", justifyContent:"center" }}>
                  <Leaf size={17} color="#a8c4ae"/>
                </div>
                <span style={{ color:"#a8c4ae", fontSize:12, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase" }}>Rajasthan Jungle Safari</span>
              </div>
              <h1 style={{ color:"#fff", fontSize:"clamp(32px,5vw,58px)", fontWeight:800, lineHeight:1.06, marginBottom:20, letterSpacing:"-.5px" }}>
                Into the Wild<br/>
                <em style={{ color:"#a8c4ae", fontStyle:"italic", fontWeight:300 }}>Heart of Rajasthan</em>
              </h1>
              <p style={{ color:"#6b9478", fontSize:16, lineHeight:1.75, maxWidth:420, marginBottom:28 }}>
                From the roar of Bengal tigers in Ranthambore to leopards draped over granite boulders in Jawai — experience the untamed, royal wilderness of Rajasthan.
              </p>
              <div style={{ display:"flex", gap:12, flexWrap:"wrap" }}>
                <button onClick={()=>document.getElementById("packages")?.scrollIntoView({behavior:"smooth"})}
                  style={{ background:"#fff", color:"#1a3d2b", border:"none", padding:"13px 28px", borderRadius:12, fontSize:15, fontWeight:700, cursor:"pointer", display:"flex", alignItems:"center", gap:8 }}>
                  Browse Packages <ArrowRight size={16}/>
                </button>
                <button onClick={()=>document.getElementById("places")?.scrollIntoView({behavior:"smooth"})}
                  style={{ background:"transparent", color:"#a8c4ae", border:"1.5px solid rgba(168,196,174,.35)", padding:"13px 28px", borderRadius:12, fontSize:15, fontWeight:600, cursor:"pointer" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
              {[
                [Users, "8,200+", "Guests Hosted"],
                [Star, "4.8 / 5", "Average Rating"],
                [Globe, "12", "Wildlife Reserves"],
                [Shield, "100%", "Safe & Certified"],
              ].map(([Icon, val, lbl]) => (
                <div key={lbl} style={{ display:"flex", alignItems:"center", gap:14, background:"rgba(255,255,255,.06)", borderRadius:12, padding:"12px 20px", border:"1px solid rgba(168,196,174,.1)" }}>
                  <div style={{ width:36, height:36, borderRadius:10, background:"rgba(168,196,174,.12)", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
                    <Icon size={17} color="#a8c4ae"/>
                  </div>
                  <div>
                    <div style={{ color:"#fff", fontSize:18, fontWeight:800, lineHeight:1 }}>{val}</div>
                    <div style={{ color:"#6b9478", fontSize:11, fontWeight:600, letterSpacing:".06em", marginTop:3 }}>{lbl.toUpperCase()}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* ═══ ACTIVITIES ════════════════════════════════════ */}
      <section style={{ background:"#b8c9bc", padding:"52px 32px" }}>
      ...
      {/* ═══ PLACES ════════════════════════════════════════ */}
      <section id="places" style={{ padding:"60px 32px", background:"#c9d4cb" }}>
        <div style={{ maxWidth:1160, margin:"0 auto" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-end", marginBottom:36, flexWrap:"wrap", gap:16 }}>
            ...
            <p style={{ color:"#4a7a5c", fontSize:14, maxWidth:380, lineHeight:1.65 }}>Each reserve offers a completely unique ecosystem — from dense jungles and granite boulders to wetlands and golden deserts.</p>
          </div>
            ...
            {places.map(p => (
              <div key={p.name} className="place-card">
                ...
                <div style={{ padding:"18px 20px 20px" }}>
                  <div style={{ fontWeight:800, fontSize:16, color:"#1a3d2b", marginBottom:8 }}>{p.name}</div>
      ...
      {/* ═══ BOOKING ════════════════════════════════════════ */}
      <section id="packages" style={{ padding:"60px 32px 80px", background:"#b8c9bc" }}>
        <div style={{ maxWidth:1160, margin:"0 auto" }}>
          ...
          <div style={{ background:"#a8bcad", borderRadius:14, padding:"0 8px", marginBottom:32, display:"inline-flex", width:"100%" }}>
            {[{n:1,lbl:"Choose Package"},{n:2,lbl:"Date & Guests"},{n:3,lbl:"Your Details"}].map(({n,lbl},i)=>(
              <div key={n} className={`step-tab${step>=n?" go":""}`} onClick={()=>step>=n&&setStep(n)}
                style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"13px 16px", opacity:step<n?.4:1, borderBottom:step===n?"2.5px solid #1a3d2b":"2.5px solid transparent", transition:"border .2s" }}>
                ...
                <span style={{ fontWeight:step===n?700:500, fontSize:13, color:"#1a3d2b", whiteSpace:"nowrap" }}>{lbl}</span>
                {i<2&&<ChevronRight size={13} color="#6b9478" style={{ marginLeft:4 }}/>}
              </div>
            ))}
          </div>
          ...
          {done ? (
            /* ── SUCCESS ── */
            <div style={{ background:"#fff", borderRadius:24, padding:"72px 40px", textAlign:"center", boxShadow:"0 8px 40px rgba(26,61,43,.1)", maxWidth:640, margin:"0 auto" }}>
              ...
              <h2 style={{ fontSize:32, fontWeight:800, color:"#1a3d2b", marginBottom:10 }}>Booking Confirmed!</h2>
              ...
              <div style={{ display:"inline-flex", gap:28, background:"#f6f9f7", borderRadius:14, padding:"20px 36px", border:"1px solid #c9d4cb", marginBottom:40, flexWrap:"wrap", justifyContent:"center" }}>
                {[[pkg?.name,"Package"],[`${month} 2026`,"Departure"],[`${guests} guest${guests>1?"s":""}`,"Guests"],[`₹${final.toLocaleString()}`,"Total"]].map(([v,l])=>(
                  <div key={l} style={{ textAlign:"center" }}>
                    <div style={{ fontWeight:800, fontSize:15, color:"#1a3d2b" }}>{v}</div>
                    <div style={{ fontSize:11, color:"#8aad93", fontWeight:600, letterSpacing:".06em", marginTop:3 }}>{l.toUpperCase()}</div>
                  </div>
                ))}
              </div>
              <br/>
              ...
              <div>
                    ...
                    {packages.map(p=>{
                      ...
                      return (
                        <div key={p.id} className={`pkg-card${on?" sel":""}`} onClick={()=>setSel(p.id)}
                          style={{ background:"#fff", borderRadius:20, overflow:"hidden", boxShadow:on?undefined:"0 2px 16px rgba(26,61,43,.07)", display:"grid", gridTemplateColumns:"260px 1fr" }}>

                          {/* Image panel */}
                          <div style={{ position:"relative", overflow:"hidden", minHeight:240 }}>
                            <img src={p.heroImg} alt={p.name} style={{ width:"100%", height:"100%", objectFit:"cover", transition:"transform .4s" }}
                            ...
                            <div style={{ position:"absolute", bottom:0, left:0, right:0, padding:"16px 18px" }}>
                              <div style={{ color:"#fff", fontSize:18, fontWeight:800, lineHeight:1.2, marginBottom:4 }}>{p.name}</div>
                          ...
                          <div style={{ padding:"22px 24px 20px", display:"flex", flexDirection:"column", justifyContent:"space-between" }}>
                            ...
                            {/* Price row */}
                            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-end", marginTop:18, paddingTop:16, borderTop:"1px solid #edf2ee" }}>
                              <div>
                                <div style={{ color:"#8aad93", fontSize:11, fontWeight:600, letterSpacing:".06em", marginBottom:2 }}>STARTS FROM</div>
                                <div style={{ display:"flex", alignItems:"baseline", gap:4 }}>
                                  <span style={{ fontSize:28, fontWeight:800, color:"#1a3d2b", letterSpacing:"-.5px" }}>₹{p.price.toLocaleString()}</span>
                                  <span style={{ color:"#8aad93", fontSize:13 }}>/ person</span>
                                </div>
                                <div style={{ color:"#6b9478", fontSize:11, marginTop:2 }}>Best time: {p.bestTime}</div>
                              </div>
                ...
                {step===2&&(
                  <div>
                    ...
                    <div style={{ background:"#fff", borderRadius:18, padding:"26px 28px", marginBottom:18, boxShadow:"0 2px 14px rgba(26,61,43,.06)" }}>
                      ...
                      <div style={{ display:"flex", alignItems:"center", gap:20, flexWrap:"wrap" }}>
                        <div style={{ display:"flex", alignItems:"center", gap:14, background:"#f4f7f5", borderRadius:14, padding:"8px 12px" }}>
                          ...
                          <div style={{ textAlign:"center", minWidth:44 }}>
                            <div style={{ fontSize:34, fontWeight:800, color:"#1a3d2b", lineHeight:1 }}>{guests}</div>
                        ...
                        {discount?(
                          <div style={{ display:"flex", alignItems:"center", gap:8, background:"#f0f7f2", borderRadius:10, padding:"10px 14px", border:"1px solid #c9d4cb" }}>
                            ...
                            <div>
                              ...
                              <div style={{ color:"#6b9478", fontSize:12 }}>Saving ₹{pkg?Math.round(total*.1).toLocaleString():"–"}</div>
                            </div>
                          </div>
                        ):(
                ...
                {step===3&&(
                  <div>
                    ...
                    <div style={{ background:"#fff", borderRadius:18, padding:"30px", boxShadow:"0 2px 14px rgba(26,61,43,.06)", marginBottom:18 }}>
                  ...
                  <div style={{ background:"#1a3d2b", padding:"22px 24px 20px", position:"relative", overflow:"hidden" }}>
                    ...
                    {pkg?(
                      <>
                        ...
                        <div style={{ color:"#fff", fontSize:17, fontWeight:800, marginBottom:4 }}>{pkg.name}</div>
                        <div style={{ display:"flex", alignItems:"center", gap:5, color:"#8aad93", fontSize:12 }}>
                      ...
                      <div style={{ color:"#a8c4ae", fontSize:15, fontWeight:600 }}>No package selected</div>
                    )}
                  </div>
                  ...
                  <div style={{ padding:"20px 24px" }}>
                    {pkg?(
                      <>
                        ...
                        <div style={{ borderTop:"1.5px dashed #e2e8e4", paddingTop:14, marginBottom:16 }}>
                          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"baseline" }}>
                            ...
                            <span style={{ fontWeight:800, fontSize:26, color:"#1a3d2b", letterSpacing:"-.5px" }}>₹{final.toLocaleString()}</span>
                          </div>
                      ...
                      <div style={{ textAlign:"center", padding:"20px 0 8px" }}>
                        ...
                        <div style={{ fontSize:14, fontWeight:500, color:"#8aad93" }}>Select a package to see pricing</div>
                      </div>
                    )}
      ...
      {/* ═══ FOOTER ═════════════════════════════════════════ */}
      <footer style={{ background:"#1a3d2b", padding:"24px 32px", textAlign:"center" }}>
        <p style={{ color:"#4a7a5c", fontSize:13 }}>© 2026 Rajasthan Jungle Safari · Discover the wild side of India · <span style={{ color:"#6b9478" }}>info@rajsafari.in</span></p>
      </footer>
    </div>
  );
}